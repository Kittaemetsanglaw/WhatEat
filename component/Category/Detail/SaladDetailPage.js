...
const SaladDetailPage = ({ route, navigation }) => {
  const { salad } = route.params;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.ratingBadge}>
        <Text style={styles.ratingText}>{salad.rating} </Text>
        <Image source={require('../../../assets/icons/Star.png')} style={styles.starIcon} />
      </View>

      <ScrollView style={styles.content}>
        <Image source={{ uri: salad.image }} style={styles.saladImage} />

        <View style={styles.priceRow}>
          <Text style={styles.price}>{salad.price}</Text>
