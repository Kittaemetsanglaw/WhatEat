  ...
  useEffect(() => {
    const fetchDesserts = async () => {
      try {
        ...
        setDesserts(data.menus); // Assuming the API returns an object with 'menus' array
      } catch (error) {
        ...
        <View style={styles.mainContent}>
          ...
          {desserts.map((item) => (
            ...
            >
                ...
                />
                <View style={styles.dessertDetails}>
                  ...
                  <Text style={styles.dessertPrice}>{item.price} ฿</Text>
                </View>
